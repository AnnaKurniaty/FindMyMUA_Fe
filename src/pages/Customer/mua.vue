            ...
            <div class="max-w-6xl mx-auto">
                ...
                <div class="mt-8 flex justify-center">
                    <nav class="inline-flex rounded-md shadow">
                        <button
                            class="px-3 py-2 rounded-l-md border border-gray-300 bg-white text-sm font-medium hover:bg-gray-50"
                        >
                            <span class="material-symbols-outlined">arrow_back_ios_new</span>
                        </button>
                        <button
                            class="px-4 py-2 border-t border-b border-gray-300 bg-primary-50 text-sm font-medium text-primary-600"
                        >
                            1
                        </button>
                        <button
                            class="px-4 py-2 border-t border-b border-gray-300 bg-white text-sm font-medium hover:bg-gray-50"
                        >
                            2
                        </button>
                    </nav>
...
<style scoped>
    ...
    *,
    ...
    #webcrumbs .bg-primary-600 {
        --tw-bg-opacity: 1;
        background-color: rgb(182 19 29 / var(--tw-bg-opacity, 1));
    }
    #webcrumbs .bg-white {
        --tw-bg-opacity: 1;
    ...
    #webcrumbs .text-primary-600 {
        --tw-text-opacity: 1;
        color: rgb(182 19 29 / var(--tw-text-opacity, 1));
    }
    ...
    #webcrumbs .hover\:bg-primary-700:hover {
        --tw-bg-opacity: 1;
        background-color: rgb(148 16 22 / var(--tw-bg-opacity, 1));
    }
