...
<style scoped>
    ...
    *,
    ...
    #webcrumbs .bg-rose-100 {
        --tw-bg-opacity: 1;
        background-color: rgb(255 228 230 / var(--tw-bg-opacity));
    }
    #webcrumbs .bg-rose-200 {
        --tw-bg-opacity: 1;
        background-color: rgb(254 205 211 / var(--tw-bg-opacity));
    }
    #webcrumbs .bg-rose-50 {
        --tw-bg-opacity: 1;
    ...
    #webcrumbs .hover\:scale-105:hover,
    #webcrumbs .hover\:transform:hover {
        transform: translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate))
            skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y));
    }
    #webcrumbs .hover\:border-rose-200:hover {
        --tw-border-opacity: 1;
        border-color: rgb(254 205 211 / var(--tw-border-opacity));
    }
    #webcrumbs .hover\:bg-rose-200:hover {
        --tw-bg-opacity: 1;
        background-color: rgb(254 205 211 / var(--tw-bg-opacity));
    }
    ...
    #webcrumbs .hover\:text-rose-600:hover {
        --tw-text-opacity: 1;
        color: rgb(225 29 72 / var(--tw-text-opacity));
    }
    #webcrumbs .hover\:text-rose-700:hover {
        --tw-text-opacity: 1;
